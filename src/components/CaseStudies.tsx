  ...
  return (
    <div className="overflow-visible">
      <a
        ...
        className="group/shot relative block min-w-0 origin-center overflow-hidden rounded-2xl border border-line bg-base-800 transition-[transform,box-shadow] duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:z-40 active:scale-[0.99] max-md:hover:scale-100 md:hover:scale-[1.4]"
        style={
          {
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.boxShadow = `0 40px 100px -40px ${accent}66, inset 0 1px 0 0 rgba(255,255,255,0.5)`;
        }}
        onMouseLeave={(e) => {
